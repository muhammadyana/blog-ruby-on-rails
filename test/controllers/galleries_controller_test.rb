...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { description: @gallery.description, image: @gallery.image, name: @gallery.name } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { description: @gallery.description, image: @gallery.image, name: @gallery.name } }
